...
@section('content')
    <section id="conteudo" class="container">
        <div>
            <form action="{{ route('logoutAdm') }}" method="POST" class="d-inline">
                @csrf
                <button type="submit" class="btn btn-danger mb-2">Sair</button>
            </form>
        ...
        <div class="row mt-5 justify-content-center">
            ...
            <div class="col-md-6 mb-4">
                <a href="{{ route('relatorio') }}" class="text-decoration-none text-dark">
                    <div class="card h-100" style="background-color:#d3d3d3;">
                        <img src="{{ asset('images/relatorio.png') }}" alt="Relatório"
                            class="img-candidato mx-auto d-block">
            ...
            <div class="col-md-6 mb-4">
                <a href="{{ route('gerenciarEleitores') }}" class="text-decoration-none text-dark">
                    <div class="card h-100" style="background-color:#d3d3d3;">
                        <img src="{{ asset('images/eleitor.png') }}" alt="Gerenciar Eleitores"
                            class="img-candidato mx-auto d-block">
            ...
            <div class="col-md-6 mb-4">
                <a href="{{ route('gerenciarEscola') }}" class="text-decoration-none text-dark">
                    <div class="card h-100" style="background-color:#d3d3d3;">
                        <img src="{{ asset('images/escola.png') }}" alt="Gerenciar Escolas"
                            class="img-candidato mx-auto d-block">
                        <h4 class="text-center mt-2">Gerenciar Escolas</h4>
                    </div>
                </a>
            </div>
